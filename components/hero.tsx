    ...
    <section className="relative pt-32 pb-0 md:pt-48 md:pb-0 overflow-hidden hero-glow-bg">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-16 lg:gap-24 items-center">
          ...
          {/* Image */}
          <div className="relative lg:order-last animate-fade-in-up animation-delay-400">
            ...
            {/* Floating card */}
            <div className="absolute -bottom-8 -left-8 glass-surface rounded-3xl shadow-2xl p-6 border-none hidden md:block animate-blob">
